...
<%--              	<script src="<c:url value="/resources/js/controller/group_controller.js" />"></script> --%>
                ...
                <script src="<c:url value="/resources/js/service/shop_service.js" />"></script>
             	<script src="<c:url value="/resources/js/controller/shop_controller.js" />"></script>
