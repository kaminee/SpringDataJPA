          ...
          <div class="panel panel-default">
              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <select ng-model="ctrl.user.country" name="" class="select input-sm" ng-options="ctr.countryId as ctr.countryName for ctr in countryAccounts track by ctr.countryId" ng-change="GetValue()">
							<option value="">--Select--</option>
    						
						</select>
						
						Selected Value is:{{ctrl.user.country}}
 						</div>
                          </div>
                      </div>
